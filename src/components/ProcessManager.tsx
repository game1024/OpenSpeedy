...
export default function ProcessManager() {
  ...
  async function toggle(pid: number, arch: string) {
    const was = enabled.has(pid);
    setEnabled(prev => { const n = new Set(prev); was ? n.delete(pid) : n.add(pid); return n; });
    await invoke(was ? "bridge_disable" : "bridge_inject", { pid, arch });
  }
